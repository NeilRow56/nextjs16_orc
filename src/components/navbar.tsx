...
import { ModeSwitcher } from './mode-switche'
...
export function Navbar() {
  return (
    <header className='bg-background/95 sticky top-0 z-50 flex h-14 shrink-0 items-center gap-2 border-b border-dashed'>
      <div className='mx-auto flex h-full w-full max-w-[1400px] items-center gap-1 px-4 md:px-6'>
        <Link href='/' className='hidden items-center gap-2 md:flex'>
          <h2 className={`${'retro'} hidden text-xs font-bold md:inline-block`}>
